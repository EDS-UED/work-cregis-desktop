...
export const SHELL_DEBUG_FLOAT_CONTENT_MARKERS =
  '.shell-debug-popover-content, .shell-debug-dev-inspect-hint, .shell-debug-dev-inspect-popover, .shell-debug-model-popover-content, .shell-debug-wnd-popover-content, .shell-debug-qa-popover, .shell-debug-effect-spec-panel';
